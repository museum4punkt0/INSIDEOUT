// This script manages the string communication via Agora
/// <Summary>
/// <href="https://assetstore.unity.com/packages/tools/video/agora-video-sdk-for-unity-134502#content">Source</see>
/// </Summary>
...
public class SendStreamMessageSample : MonoBehaviour 
{
    ...
    public Text LogText;
    static public string messagestring = "-5, 0";
	...
	public void SendMessage(string message)
    {
        ...
        this._logger.UpdateLog("SendStreamMessage :" + rc + "Stream ID: "+streamId);
        Debug.Log("SendStreamMessage :" + rc + "Stream ID: "+streamId);
    }
